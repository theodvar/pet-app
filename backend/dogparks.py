...
@app.route('/api/dogparks', methods=['GET'])
def read_table():
    """
    Endpoint to fetch all rows from the dogparks table.
    """
    try:
...
@app.route('/api/dogparks/<int:id>', methods=['GET'])
...
@app.route('/api/dogparks', methods=['POST'])
...
@app.route('/api/dogparks/<int:id>', methods=['DELETE'])
def delete_dogpark(id):
    """
    Endpoint to delete a record from the dogparks table by id.
    """
    try:
        # Establish database connection
        connection = get_db_connection()
...
@app.route('/api/dogparks/<int:id>', methods=['PUT'])
def update_dogpark(id):
    """
    Endpoint to update an existing record in the dogpark table.
    """
